// import { loadSong, gotoPreviousSong, gotoNextSong, playPauseMedia, updateProgress, setProgress } from './app.js';
...
// prev.addEventListener('click', () => gotoPreviousSong(songIndex));
// next.addEventListener('click', () => gotoNextSong(songIndex));

// progressContainer.addEventListener('mousedown', debounce(setProgress, 200));
